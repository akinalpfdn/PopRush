...
/**
 * Setup screen for Coop Mode, shown to the host after mode selection.
 * Allows configuring game duration and starting the match.
 */
@Composable
fun CoopSetupScreen(
    ...
    Box(
        ...
        Column(
            ...
            // Selected mode label
            Text(
                text = coopGameState.selectedCoopMod.displayName,
